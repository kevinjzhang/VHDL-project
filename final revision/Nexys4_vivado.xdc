...
## slideSwitchesitches
#Bank = 34, Pin name = IO_L21P_T3_DQS_34,					Sch name = slideSwitches0
set_property PACKAGE_PIN U9 [get_ports {slideSwitches[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[0]}]
#Bank = 34, Pin name = IO_25_34,							Sch name = slideSwitches1
set_property PACKAGE_PIN U8 [get_ports {slideSwitches[1]}]	
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[1]}]
#Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = slideSwitches2
set_property PACKAGE_PIN R7 [get_ports {slideSwitches[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[2]}]
#Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = slideSwitches3
set_property PACKAGE_PIN R6 [get_ports {slideSwitches[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[3]}]
#Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = slideSwitches4
set_property PACKAGE_PIN R5 [get_ports {slideSwitches[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[4]}]
#Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = slideSwitches5
set_property PACKAGE_PIN V7 [get_ports {slideSwitches[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[5]}]
#Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = slideSwitches6
set_property PACKAGE_PIN V6 [get_ports {slideSwitches[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[6]}]
#Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = slideSwitches7
set_property PACKAGE_PIN V5 [get_ports {slideSwitches[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[7]}]
#Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = slideSwitches8
set_property PACKAGE_PIN U4 [get_ports {slideSwitches[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[8]}]
#Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = slideSwitches9
set_property PACKAGE_PIN V2 [get_ports {slideSwitches[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[9]}]
#Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = slideSwitches10
set_property PACKAGE_PIN U2 [get_ports {slideSwitches[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[10]}]
#Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = slideSwitches11
set_property PACKAGE_PIN T3 [get_ports {slideSwitches[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[11]}]
#Bank = 34, Pin name = IO_L17N_T2_34,						Sch name = slideSwitches12
set_property PACKAGE_PIN T1 [get_ports {slideSwitches[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[12]}]
#Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = slideSwitches13
set_property PACKAGE_PIN R3 [get_ports {slideSwitches[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[13]}]
#Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = slideSwitches14
set_property PACKAGE_PIN P3 [get_ports {slideSwitches[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[14]}]
#Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = slideSwitches15
set_property PACKAGE_PIN P4 [get_ports {slideSwitches[15]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {slideSwitches[15]}]
 

## LEDss
#Bank = 34, Pin name = IO_L24N_T3_34,						Sch name = LEDs0
set_property PACKAGE_PIN T8 [get_ports {LEDs[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[0]}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LEDs1
set_property PACKAGE_PIN V9 [get_ports {LEDs[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[1]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LEDs2
set_property PACKAGE_PIN R8 [get_ports {LEDs[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[2]}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LEDs3
set_property PACKAGE_PIN T6 [get_ports {LEDs[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[3]}]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LEDs4
set_property PACKAGE_PIN T5 [get_ports {LEDs[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[4]}]
#Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LEDs5
set_property PACKAGE_PIN T4 [get_ports {LEDs[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[5]}]
#Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = LEDs6
set_property PACKAGE_PIN U7 [get_ports {LEDs[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[6]}]
#Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = LEDs7
set_property PACKAGE_PIN U6 [get_ports {LEDs[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[7]}]
#Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = LEDs8
set_property PACKAGE_PIN V4 [get_ports {LEDs[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[8]}]
#Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = LEDs9
set_property PACKAGE_PIN U3 [get_ports {LEDs[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[9]}]
#Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LEDs10
set_property PACKAGE_PIN V1 [get_ports {LEDs[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[10]}]
#Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LEDs11
set_property PACKAGE_PIN R1 [get_ports {LEDs[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[11]}]
#Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LEDs12
set_property PACKAGE_PIN P5 [get_ports {LEDs[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[12]}]
#Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LEDs13
set_property PACKAGE_PIN U1 [get_ports {LEDs[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[13]}]
#Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LEDs14
set_property PACKAGE_PIN R2 [get_ports {LEDs[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[14]}]
#Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LEDs15
set_property PACKAGE_PIN P2 [get_ports {LEDs[15]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {LEDs[15]}]

##Bank = 34, Pin name = IO_L5P_T0_34,						Sch name = LEDs16_R
#set_property PACKAGE_PIN K5 [get_ports RGB1_Red]					
#	set_property IOSTANDARD LVCMOS33 [get_ports RGB1_Red]
##Bank = 15, Pin name = IO_L5P_T0_AD9P_15,					Sch name = LEDs16_G
#set_property PACKAGE_PIN F13 [get_ports RGB1_Green]				
#	set_property IOSTANDARD LVCMOS33 [get_ports RGB1_Green]
##Bank = 35, Pin name = IO_L19N_T3_VREF_35,					Sch name = LEDs16_B
#set_property PACKAGE_PIN F6 [get_ports RGB1_Blue]					
#	set_property IOSTANDARD LVCMOS33 [get_ports RGB1_Blue]
##Bank = 34, Pin name = IO_0_34,								Sch name = LEDs17_R
#set_property PACKAGE_PIN K6 [get_ports RGB2_Red]					
#	set_property IOSTANDARD LVCMOS33 [get_ports RGB2_Red]
##Bank = 35, Pin name = IO_24P_T3_35,						Sch name =  LEDs17_G
#set_property PACKAGE_PIN H6 [get_ports RGB2_Green]					
#	set_property IOSTANDARD LVCMOS33 [get_ports RGB2_Green]
##Bank = CONFIG, Pin name = IO_L3N_T0_DQS_EMCCLK_14,			Sch name = LEDs17_B
...
set_property PACKAGE_PIN H4 [get_ports {logic_analyzer[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {logic_analyzer[4]}]

set_property PACKAGE_PIN H1 [get_ports {logic_analyzer[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {logic_analyzer[5]}]

set_property PACKAGE_PIN G1 [get_ports {logic_analyzer[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {logic_analyzer[6]}]
	
set_property PACKAGE_PIN G3 [get_ports {logic_analyzer[7]}]			
...
set_property PACKAGE_PIN C17 [get_ports {ext_clk2}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ext_clk2}]
...
set_property PACKAGE_PIN J4 [get_ports {rx}]					
